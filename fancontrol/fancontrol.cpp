...
//  	// C0-C4 (state index 8-11)
	...
	this->SmartLevels[i].temp= 50;  this->SmartLevels[i].fan= 255; i++;
	this->SmartLevels[i].temp= 55;  this->SmartLevels[i].fan= 200; i++;
	this->SmartLevels[i].temp= 60;  this->SmartLevels[i].fan= 170; i++;
	this->SmartLevels[i].temp= 65;  this->SmartLevels[i].fan= 140; i++;
	this->SmartLevels[i].temp= 70;  this->SmartLevels[i].fan= 0; i++;
	this->SmartLevels[i].temp= -1;  this->SmartLevels[i].fan= 0; i++;

	setzero(this->SmartLevels1, sizeof(this->SmartLevels1));
	i= 0;
	this->SmartLevels1[i].temp1= 50;  this->SmartLevels1[i].fan1= 255; i++;
	this->SmartLevels1[i].temp1= 55;  this->SmartLevels1[i].fan1= 200; i++;
	this->SmartLevels1[i].temp1= 60;  this->SmartLevels1[i].fan1= 170; i++;
	this->SmartLevels1[i].temp1= 65;  this->SmartLevels1[i].fan1= 140; i++;
	this->SmartLevels1[i].temp1= 70;  this->SmartLevels1[i].fan1= 0; i++;
