...
//  	// C0-C4 (state index 8-11)
	...
	for (int _i = 0; _i < 111; _i++) {
		...
		case 0:
			...
			break;            //blank
		case 1:
			this->Title3[1] = bias - 2;
			break;        //b
		case 2:
			this->Title3[2] = bias + 21;
			break;        //y
		case 3:
			this->Title3[3] = 32;
			break;            //blank
		case 4:
			this->Title3[4] = bias + 16;
			break;        //t
		case 5:
			this->Title3[5] = bias + 14;
			break;        //r
		case 6:
			this->Title3[6] = bias + 11;
			break;        //o
		case 7:
			this->Title3[7] = bias + 17;
			break;        //u
		case 8:
			this->Title3[8] = bias - 2;
			break;        //b
		case 9:
			this->Title3[9] = bias - 3;
			break;        //a
		case 10:
			this->Title3[10] = bias;
			break;            //d
		case 11:
			this->Title3[11] = bias + 5;
			break;        //i
		case 12:
			this->Title3[12] = bias + 20;
			break;    //x
		case 13:
			this->Title3[13] = 32;
			break;            //blank
